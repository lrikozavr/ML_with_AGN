...
output_path_mod_one = "/home/kiril/github/AGN_article_final_data/inform/mod_normal_1"
output_path_weight_one = "/home/kiril/github/AGN_article_final_data/inform/weight_normal_1"

output_path_mod_dark = "/home/kiril/github/AGN_article_final_data/inform/mod_dark_1"
output_path_weight_dark = "/home/kiril/github/AGN_article_final_data/inform/weight_dark_1"
...
for name in os.listdir(slice_path):
    ...
    local_ML(f"{output_path_predict}_{name}_normal.csv",data,train[features],batch_size,output_path_mod_one,output_path_weight_one,optimizer,loss)
    local_ML(f"{output_path_predict}_{name}_dark.csv",data,train[features],batch_size,output_path_mod_dark,output_path_weight_dark,optimizer,loss)
