...
$s_path/train_pipe_1.sh star1.csv star2.csv 5 | awk -F, '{printf("%s,%s,%s\n",$1,$2,($3+$6)/2.)}' > star.csv
$s_path/train_pipe_1.sh qso1.csv qso2.csv 5 | awk -F, '{printf("%s,%s,%s\n",$1,$2,($3+$6)/2.)}' > qso.csv
$s_path/train_pipe_1.sh gal1.csv gal2.csv 5 | awk -F, '{printf("%s,%s,%s\n",$1,$2,($3+$6)/2.)}' > gal.csv
